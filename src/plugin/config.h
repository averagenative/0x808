/*
 * config.h — CPLUG plugin configuration for 0x808.
 *
...
#define CPLUG_COMPANY_NAME   "0x808"
#define CPLUG_COMPANY_EMAIL  ""
#define CPLUG_PLUGIN_NAME    "0x808"
#define CPLUG_PLUGIN_URI     "https://github.com/averagenative/0x808"
...
/* CLAP identification */
#define CPLUG_CLAP_ID          "com.0x808.plugin"
